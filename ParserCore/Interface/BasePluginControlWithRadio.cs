...
{
    public partial class BasePluginControlWithRadio : UserControl, IPlugin
    {
        #region Constructor
        public BasePluginControlWithRadio()
        {
            InitializeComponent();
        ...
        protected virtual void radioButton1_CheckedChanged(object sender, EventArgs e)
        {

        }

        protected virtual void radioButton2_CheckedChanged(object sender, EventArgs e)
        {

        }

        protected virtual void radioButton3_CheckedChanged(object sender, EventArgs e)
        {
